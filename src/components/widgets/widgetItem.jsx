...
export function WidgetItem(props) {
    ...
    const { setPage, setCurrentWidget, wrappedSetAddWidget } = useWidgetContext()
    ...
    return (
        <div class="relative h-34 rounded-md border-gs-90 border p-3">
            ...
            <p onclick={() => {
                ...
                setPage('widgetInfo')
            }} class='absolute bottom-3 text-xs text-gs-50 ml-4 hover:cursor-pointer underline-animation-container w-fit [&:hover>span:nth-child(2)]:pl-2'>
